...
namespace AudioFingerprint
{
    ...
    public class ResultEntry
    {
        ...
        public ResultEntry(int diskotekNr, int sideNr, int sequenceNr, string songName, object reference, long fingerTrackID, int similarity, int timeIndex, int indexNumberInMatchList, int subFingerCountHitInFingerprint, SearchStrategy searchStrategy, int searchIteration)
        {
